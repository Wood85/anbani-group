...
export const translations: Translations = {
  ru: {
    "header.subtitle": "Мебель на заказ, отражающая ваш стиль",
    "menu.about": "О нас",
    "menu.services": "Услуги",
    "menu.contacts": "Контакты",
    "contacts.phone": "Телефон",
    "hero.title": "Мебель на заказ, отражающая ваш стиль",
  ...
  en: {
    ...
    "hero.title": "Made-to-order furniture that fits your style",
    "hero.subtitle":
